...
export default class PatientDiary extends Component {
    ...
    getDiary = async (id) => {
        ...
        http.get(`/admin/users/${id}/diary`, { headers: { 'Authorization': `Bearer ${user.jwt}` } })
            .then(resp => {
            ...
            <View style={styles.fillSpace}>
                ...
                <View style={{ flex: 1, width: '100%' }}>
                    ...
                    <View style={{ width: '100%', height: '25%', justifyContent: "center", alignItems: "center" }}>
                        <Text style={[styles.bodyText, { color: theme.colorMenuHeading, marginVertical: theme.size(15) }]}>First Note Taken</Text>
                        <Text style={[styles.bodyText, { color: theme.colorMenuHeading, fontSize: theme.size(26), textAlign:'center' }]}>
                            {
