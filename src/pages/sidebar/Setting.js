    ...
    render() {
        return (
            <View style={styles.fillSpace}>
                <Header title={'Settings'} changeDrawer={this.goBack} icon={'arrow-back'} logout={this.logout} customStyles={{paddingTop: Platform.OS === 'ios' ? (60 * Dimensions.get('window').height)/896 : 20, height: Platform.OS === 'ios' ? (120 * Dimensions.get('window').height)/896 : 80}}/>
                <View style={{ width: '100%', height: '95%' }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '25%', width: '100%', backgroundColor: '#000000' }}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('AppPasscode')} style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%', backgroundColor: '#ffffff', borderRightWidth: 1, borderRightColor: theme.colorPrimary, borderBottomWidth: 1.50, borderBottomColor: theme.colorPrimary }}>
                            <Icon name="key-outline" type="material-community" />
                            <Text style={[styles.h2, { fontFamily: theme.font.regular }]}>App passcode</Text>
                            <Divider style={{ alignSelf: 'center', backgroundColor: "black", marginTop: theme.size(20), height: theme.size(5), width: '10%' }} />
                        </TouchableOpacity>
                        <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%', backgroundColor: '#ffffff', borderLeftWidth: 1, borderLeftColor: theme.colorPrimary, borderBottomWidth: 1.50, borderBottomColor: theme.colorPrimary }} onPress={() => { this.setState({ donateSessionVisible: true }) }}>
                            <Icon name="gift-outline" type="material-community" />
                            <Text style={[styles.h2, { fontFamily: theme.font.regular, textAlign: 'center', }]}>Donate a session</Text>
                            <Divider style={{ alignSelf: 'center', backgroundColor: "black", marginTop: theme.size(20), height: theme.size(5), width: '10%' }} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '25%', width: '100%', backgroundColor: '#000000', }}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('Subscribe')} style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%', backgroundColor: '#ffffff', borderRightWidth: 1, borderRightColor: theme.colorPrimary, borderTopWidth: 0.5, borderBottomColor: theme.colorPrimary, borderBottomWidth: 0.50, borderBottomColor: theme.colorPrimary }}>
                            <Icon name="bell-ring-outline" type="material-community" />
                            <Text style={[styles.h2, { fontFamily: theme.font.regular }]}>Subscribe</Text>
                            <Divider style={{ alignSelf: 'center', backgroundColor: "black", marginTop: theme.size(20), height: theme.size(5), width: '10%' }} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.setState({ privacyPolicyModalVisible: true })} style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%', backgroundColor: '#ffffff', borderLeftWidth: 1, borderLeftColor: theme.colorPrimary, borderTopWidth: 0.5, borderTopColor: theme.colorPrimary, borderBottomWidth: 0.50, borderBottomColor: theme.colorPrimary }}>
                            <Icon name="shield-account-outline" type="material-community" />
                            <Text style={[styles.h2, { fontFamily: theme.font.regular }]}>Privacy Policy</Text>
                            <Divider style={{ alignSelf: 'center', backgroundColor: "black", marginTop: theme.size(20), height: theme.size(5), width: '10%' }} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '25%', width: '100%', backgroundColor: '#000000' }}>
                        <TouchableOpacity onPress={() => this.setState({ termsModalVisible: true })} style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%', backgroundColor: '#ffffff', borderRightWidth: 1, borderRightColor: theme.colorPrimary, borderTopWidth: 1.50, borderTopColor: theme.colorPrimary }}>
                            <Icon name="note-outline" type="material-community" />
                            <Text style={[styles.h2, { fontFamily: theme.font.regular }]}>Terms of Use</Text>
                            <Divider style={{ alignSelf: 'center', backgroundColor: "black", marginTop: theme.size(20), height: theme.size(5), width: '10%' }} />
                        </TouchableOpacity>
                        <View style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%', backgroundColor: '#ffffff', borderLeftWidth: 1, borderLeftColor: theme.colorPrimary, borderTopWidth: 1.50, borderTopColor: theme.colorPrimary }}>
                        </View>
                    </View>
                    <TermsModal
                    ...
                    {/* Bottom Navigation */}
                    {
                        this.state.user.role === roles.admin
                            ?
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('Dashboard')} style={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', height: '35%', width: '100%', backgroundColor: '#000000' }}>
                                <View style={{ height: '10%', width: '100%', backgroundColor: theme.colorGrey }} />
                    ...
                    }
                    {
                        this.state.user.role === roles.therapist
                            ?
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('Dashboard')} style={{ flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', height: '35%', width: '100%', backgroundColor: '#000000' }}>
                                <View style={{ height: '10%', width: '100%', backgroundColor: "#d3d3d3" }} />
                                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={[theme.colorGradientStart, theme.colorGradientEnd]} style={{ height: '100%', width: '100%', backgroundColor: theme.colorPrimary }} >
                                    <View style={{ flexDirection: 'row', height: '30%', width: '100%' }}>
                                        <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '50%' }} onPress={() => this.props.navigation.navigate('TherapistProfile', { jwt: this.state.user.jwt, back: 'Settings' })}>
