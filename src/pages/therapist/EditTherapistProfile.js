        ...
        return (
            <View style={styles.fillSpace}>
                <View style={{ flex: 1, justifyContent: 'space-between' }}>
                    <Header title={'Edit profile'} changeDrawer={this.goBack} icon={'arrow-back'} customStyles={{ paddingTop: theme.size(0), height: theme.size(56) }} iconRight={'exit-to-app'} logout={this.logout} />
                    <ScrollView style={[styles.bodyPadding]}>
                        ...
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginTop: theme.paddingBodyVertical }}>
                            ...
                            <Input placeholder={"About"} leftIcon={{ name: 'information-outline', type: 'material-community', color: theme.colorGrey }} onChange={this.onChange} propertyName={'about'} multiline={true} numberOfLines={3} value={this.state.about} />
